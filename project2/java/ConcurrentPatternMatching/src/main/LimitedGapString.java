...
/**
 * A limited gap string is a gap string where only a specified number of
 * characters may appear between the prefix and suffix.
 * @author Hieu Le
 * @version 10/23/16
 */
public class LimitedGapString {
    // The regex patterns for gap length specification.
     ...
     * The notation must be of the form <prefix> <min>..<max> <suffix> where
     * min and max are non-negative integers such that min is less than or
     * equal to max.
     * @param prefix The prefix of this limited gap string.
     * @param suffix The suffix of this limited gap string.
     * @param gapLengthRange The range for the number of characters permitted
     *                       between prefix and suffix.
     * @return If executed successfully, returns a fully constructed
     * LimitedGapString object.
     */
    ...
    /**
     * Returns the minimum number of characters permitted between prefix
     * and suffix.
    ...
    /**
     * Returns the maximum number of characters permitted between prefix
     * and suffix.
